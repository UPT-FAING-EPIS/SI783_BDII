...
3. Ubicarse en un ruta que no sea del sistema. Crear la carpeta ServicioCliente y la carpeta db dentro de esta.
```
...
docker-compose up -d
```
8. Esperar un minuto que inicie correctamente el contenedor y ejecutar el siguiente comando:
```Bash
